...
export class Screens {
  ...
  showPause(options: MenuOption[]): void {
      ...
      h(
        ...
        h(
          ...
          h(
            ...
            h('dd', {}, 'frapper'),
            h('dt', {}, 'Clic droit'),
            h('dd', {}, 'bloquer, remplit la rage'),
            h('dt', {}, 'Espace'),
            h('dd', {}, 'esquiver'),
            h('dt', {}, 'A'),
            h('dd', {}, 'frappe fracassante (demi-rage)'),
            h('dt', {}, 'E'),
            h('dd', {}, 'bond (au combat, 25 de rage)'),
            h('dt', {}, 'R'),
            h('dd', {}, 'frénésie (au combat, 30 de rage)'),
            h('dt', {}, 'I / J / K'),
